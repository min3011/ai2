...
content_data = {
    labels[0]: {
        ...
        'texts': [
            "Label 1 작품1 밥 잘 사주는 예쁜 누나 '그냥 아는 사이'로 지내던 두 남녀가 사랑에 빠지면서 그려가게 될 '진짜 연애'에 대한 이야기",
            "Label 1 작품2 그 해 우리는 함께해서 더러웠고 다신 보지 말자!로 끝났어야 할 인연이 10년이 흘러 카메라 앞에 강제 소환 되어 펼쳐지는 청춘 다큐를 가장한 아찔한 로맨스 드라마",
            "Label 1 작품3 멜로가 체질 서른 살 여자 친구들의 고민, 연애, 일상을 그린 코믹 드라마"
        ]
    },
    labels[1]: {
        'images': [
        ...
        'texts': [
            "Label 2 작품1 사랑의 불시착 어느 날 돌풍과 함께 패러글라이딩 사고로 북한에 불시착한 재벌 상속녀 윤세리와 그녀를 숨기고 지키다 사랑하게 되는 특급 장교 리정혁의 절대 극비 러브스토리를 그린 드라마",
            "Label 2 작품2 THE K2 전쟁 용병 출신의 보디가드 K2와 그를 고용한 대선 후보의 아내, 그리고 세상과 떨어져 사는 소녀! 로열패밀리를 둘러싼 은밀하고 강렬한 보디가드 액션 드라마",
            "Label 2 관련 복수가 돌아왔다 학교 폭력 가해자로 몰려 부당하게 퇴학을 당한 강복수가, 어른이 돼 학교로 다시 돌아가 복수를 계획하지만, 복수는 고사하고 또다시 사건에 휘말리고 사랑도 다시 하는 엉뚱하면서 따뜻한 감성 로맨스 드라마"
        ]
    }
